defmodule Advent2021.Day7.Part2 do
  def run do
    "./priv/day_7_input"
    |> File.read!()
    |> String.trim()
  ...
  defp add_fuel(new_position, curr_position, fuel_map) do
    ...
    diff = abs(new_position - curr_position)
    new_fuel = curr_fuel + diff * (diff + 1) / 2
    new_fuel_map = Map.put(fuel_map, new_position, trunc(new_fuel))
